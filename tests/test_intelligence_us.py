...
from trace.intelligence.processing import normalize
from trace.intelligence.service import IntelligenceHub
from trace.intelligence.sources import Source, parse_x
...
class USIntelligenceTests(unittest.TestCase):
    ...
    def test_us_scope_filters_crypto_and_keeps_company_and_policy_reports(self):
        ...
        self.assertEqual({e["category"] for e in result["events"]}, {"earnings", "policy"})
