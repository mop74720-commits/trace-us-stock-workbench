...
class IntelligenceHub:
    def __init__(self, path: Path, sources: list[Source], config_dir: Optional[Path] = None, allow_x=False, fetcher=collect):
    ...
    def ingest(self, source: Source, raw_items: list[dict], observed_at: Optional[float]=None, batch: Optional[Batch]=None):
    ...
    def digest(self, as_of: Optional[float]=None, context=None, include_candidates=False):
